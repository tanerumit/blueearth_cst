...
| [`inspect_spatial_ref.py`](inspect_spatial_ref.py) | Whether `spatial_ref.x_dim` / `y_dim` attrs propagate through weathergenr's `write_netcdf` (they don't — see `dev/weathergenr_bugs.md`). |
