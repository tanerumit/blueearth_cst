...
| GF15 | Operational contracts preserved. Original and normalized-B full qualification audits passed but scientific adequacy failed (3/24 baseline cells; all six n=18 cells fail). The [alternative design](../gf15-alternative-estimator-design.md) is owner-approved; [Stage 1 readiness](evidence/gf15-lmoments-readiness/results/independent/scientific-handoff.md) is independently accepted for attempt-2 on 2026-09-12 (45 tests, three population controls, 19 branches, 88 dual-precision comparisons, complete predecessor audit). Stage 2 awaits separate release. No candidate qualification, production integration or seal approval follows. |
