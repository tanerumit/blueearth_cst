...
source: "https://deltares.github.io/hydromt/latest/user_guide/models/model_overview.html"
reference: "HydroMT team. (n.d.). *Working with models*. HydroMT documentation. Retrieved May 10, 2026, from sources/tools/hydromt/hydromt-user-guide/03-models.md"
topic: tools
type: documentation
promoted: 2026-05-10
tags:
...
# 3 HydroMT user guide — Working with models
...
Building a model  Updating a model  Model workflow file  Defining a region  Model components (advanced)  Model processes (advanced)
...
<img src="https://deltares.github.io/hydromt/latest/_images/region.png" alt="Examples of region types supported in HydroMT" />
...
## 3.10 The anatomy of a components
...
## 3.11 Adding components to a model
