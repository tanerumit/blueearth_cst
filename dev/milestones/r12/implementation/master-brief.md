...
- [P2 — durable handoffs](phase-2-durable-handoffs.md) — started: identities and adapter-backed collection lifecycle verified; production preparation binding, checkpoints and integration pending
