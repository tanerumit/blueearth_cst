...
| GF15 | Operational contracts preserved. Original and normalized-B scientific qualifications failed. The [alternative design](../gf15-alternative-estimator-design.md) and [Stage 1 readiness](evidence/gf15-lmoments-readiness/results/independent/scientific-handoff.md) are accepted. [Stage 2](evidence/gf15-lmoments-qualification/execution-handoff.md) is mechanically complete: 132,000 accepted fits, 144,000 quantiles; observed accuracy passes 3/24 baseline and 6/72 eligible scale-plus-relative cells, while all 120,000 translation pairs pass (maximum difference 5.884e-12). [Stage 3 independent assessment](evidence/gf15-lmoments-assessment/scientific-handoff.md) is complete on 2026-09-13: exact audit passed; candidate qualification failed, including all six n=18 baseline cells. The owner-selected [threefold error policy](evidence/gf15-accuracy-3x/scientific-handoff.md) also fails: 124/144 overall, 23/24 baseline and 55/72 eligible combined cells pass; n=18 baseline passes 6/6 but five relative-error cells fail. The owner then selected [eightfold limits](evidence/gf15-accuracy-8x/scientific-handoff.md): C passes 24/24 baseline, 72/72 eligible combined and 144/144 overall cells, including all 36 n=18 cells. All 120,000 translation pairs pass. This conditional policy pass preserves original and threefold failures; it is not fresh validation. Production applicability/integration and seal requirements remain open. |
