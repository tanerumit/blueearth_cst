...
set CFG=config/snake_config_model_test_local.yml
...
snakemake all -c 1 -s Snakefile_model_creation --configfile %CFG%
...
snakemake all -c 1 -s Snakefile_climate_projections --configfile %CFG% --keep-going
...
snakemake all -c 1 -s Snakefile_climate_experiment --configfile %CFG%
