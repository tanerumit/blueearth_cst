...
``snake_utils``, and settings schema in ``advanced_settings``, so their edits
cannot change a collection identity.
"""
...
from blueearth_cst.shared.advanced_settings import (
    _MONTH_ABBREVS,
    ADVANCED_SETTINGS,
    _month_abbrev,
    _nonnegative_int,
