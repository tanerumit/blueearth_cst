# R13 — Config modularization: Design (DRAFT v5)

> **Status: DRAFT v5** — v2 (revised against the internal three-lens panel:
...
> this revision implements those rulings; there is no further external round.
