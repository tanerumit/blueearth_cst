# Complete-run output tree and record schemas — P0 contract, design v2
...
| ID | Status at v2 | Evidence/result and required observation | Closure |
|---|---|---|---|
